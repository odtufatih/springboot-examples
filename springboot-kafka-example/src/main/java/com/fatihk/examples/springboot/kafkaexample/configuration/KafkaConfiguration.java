package com.fatihk.examples.springboot.kafkaexample.configuration;
...
public class KafkaConfiguration {
    ...
    @Bean
    public KafkaTemplate<String, ServiceLog> kafkaTemplate() {
    ...
    public ConsumerFactory<String, ServiceLog> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ServiceLog.class);
